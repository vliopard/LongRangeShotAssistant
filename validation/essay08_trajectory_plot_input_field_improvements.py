...
def shoot(starting_velocity, angle, starting_arrow_x0, starting_arrow_y_red, floor_lvl, floor_hgt, stop_me):
    ...
    reticle_aim(600, 10, 250, py_red, 'red', 30)
    reticle_aim(600, 10, 250, py_green, 'green', 20)
    reticle_aim(600, 10, 250, py_gray, 'blue', 10)
...
def runme(inclination_angle, stpm):
    canvas.delete("all")
    reticle(600, 10, 250, inclination_angle, stopme)
    
    draw_element(initial_x, initial_y, 'blue', 4, 4)
    shoot(initial_speed, inclination_angle, initial_x, initial_y, floor_level, floor_height, stpm)
