...
def shoot(speed, angle, position_x, position_y):
    ...
    while position_y >= 0:
        ...
        if block == 2:
            accel_x = -friction * speed_x * speed_x
            accel_y = -friction * speed_y * speed_y - gravity

        if block == 3:
            accel_x = -friction * speed_x * speed_x / mass
            accel_y = -friction * speed_y * speed_y / mass - gravity
